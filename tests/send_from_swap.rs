...
use bitcoind::bitcoincore_rpc::{self, jsonrpc::client, RawTx};
use coinswap::{
    
    maker::{start_maker_server, MakerBehavior},
    taker::SwapParams,
    test_framework::*,
    wallet::{Destination,CoinToSpend,SendAmount,UTXOSpendInfo, Wallet}      
...
async fn test_spending_from_settled_swapcoin() {
   ...
   .unwrap();
    ...
    .iter()
    .find(|(_, spend_info)| matches!(spend_info, UTXOSpendInfo::SwapCoin(_)))
{
{
